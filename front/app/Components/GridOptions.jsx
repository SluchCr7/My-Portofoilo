...
const GridOptions = ({setIsOpen}) => {
  return  (
    <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-6 gap-4 p-4 w-full">
        {/* كارت احترافي مقسم داخليًا مع صور محسنة */}
        <div className="md:col-span-3 lg:col-span-3 h-[60vh] bg-gradient-to-br from-Black-100 via-Black-200 to-Black-300 rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="relative w-full md:w-1/2 h-1/2 md:h-full">
            ...
            {/* sub image فوق الصورة الرئيسية بشكل احترافي */}
            <div className="absolute bottom-6 left-6 w-[60%] aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-white/10 backdrop-blur-md bg-white/5 hover:scale-105 transition-all duration-300 z-10">
              <Image
                src="/assets/b5.svg"
                alt="Sub image"
                fill
